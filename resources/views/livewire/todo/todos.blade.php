<x-slot name="header">
    ...
    <td class="border px-4 py-2"><img src="{{ Storage::url($todo->image) }}"></td>
    ...
    <button wire:click="delete({{ $todo->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="return confirm('Yakin ingin menghapus?') || event.stopImmediatePropagation()">Delete</button>
    </td>
    </tr>
    @endforeach
    </tbody>
